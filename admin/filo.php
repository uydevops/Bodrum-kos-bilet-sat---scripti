...
<div class="container light-style flex-grow-1 container-p-y">
    ...
    <div class="col-md-9">
        <div class="tab-content">
            <div class="tab-pane fade active show" id="account-general">
                ...
                <form action="islemler/add2.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="form-label">Filo Adi</label>
                            <input type="text" name="filo_baslik" class="form-control mb-1" value="">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Yolcu Kapasitesi</label>
                            <input type="text" name="yolcu" class="form-control mb-1" value="">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Tekne Kodu</label>
                            <input type="text" name="tekne_k" class="form-control mb-1" value="">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Motor Bilgileri</label>
                            <input type="text" name="motor" class="form-control mb-1" value="">
                        </div>

                        <div class="form-group w-100">
                            <label class="form-label">Metin</label>
                            <textarea name="filo_metin" class="ckeditor" name="deger" cols="30" rows="10"></textarea>
                        </div>
                    </div>
    ...
    <div class="text-center mt-1">
        <button type="submit" name="filo_ekle" class="btn btn-primary">Kaydet</button>&nbsp;
    </div>
    </form>
</div>
