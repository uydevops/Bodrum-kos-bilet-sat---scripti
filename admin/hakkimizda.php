            ...
            <div class="tab-pane fade active show" id="account-general">
                ...
                <form action="islemler/update.php" method="POST" enctype="multipart/form-data">
                    <div class="card-body media align-items-center">
                        <img src="<?php echo $hak["resim"]; ?>" alt="" class=" d-block ui-w-80">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="metin_baslik" class="form-control mb-1" value="<?php echo   $hak["metin_baslik"] ?>">
                        </div>

                        <div class="form-group w-100">
                            <label class="form-label">Metin</label>
                            <textarea name="metin" class="ckeditor" name="deger" cols="30" rows="10"><?php echo $hak["metin"]; ?></textarea>
                        </div>
                    </div>
