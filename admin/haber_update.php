...
if (isset($_GET["haber_id"])) {
    $id = $_GET["haber_id"];
    $haber = $db->prepare("SELECT * FROM haberler WHERE id=?");
    $haber->execute(array($id));
    $ha = $haber->fetch(PDO::FETCH_ASSOC);
}
?>
<br>
<br>
...
$son = substr($targetFile,27);
    ...
    $img=$db->prepare("INSERT INTO image SET parent_id=?,image=?");
...
<div class="container light-style flex-grow-1 container-p-y">
    ...
    <div class="col-md-9">
        <div class="tab-content">
            <div class="tab-pane fade active show" id="account-general">
                ...
                <form action="islemler/update.php?haber_id=<?php echo $ha["id"]; ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="haber_baslik" class="form-control mb-1" value="<?php echo $ha["haber_baslik"]; ?>">
                        </div>

                        <div class="form-group w-100">
                            <label class="form-label">Metin</label>
                            <textarea name="haber_metin" class="ckeditor" name="deger" cols="30" rows="10"><?php echo $ha["haber_metin"]; ?></textarea>
                        </div>
                    </div>
    ...
    <div class="text-center mt-1">
        <button type="submit" name="haber_update" class="btn btn-primary">Kaydet</button>&nbsp;
    </div>
    </form>
</div>
