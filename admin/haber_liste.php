                            ...
                            <table class="table user-list">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th><span>Haber Baslik</span></th>
                                        <th class="text-center"><span>Haber Metin</span></th>
                                        <th>&nbsp;</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    $user_cek = $db->prepare("SELECT *FROM haberler");
                                    $user_cek->execute();
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <span class="label label-default"><?php echo $row["metin"]; ?></span>
                                            </td>
                                            <td>
                                            ...
                                            <td style="width: 20%;">
                                                ...
                                                <a href="haber_update.php?haber_id=<?php echo $row["id"]; ?>"" class=" table-link text-info">
                                                    <span class="fa-stack">
                                                        <i class="fa fa-square fa-stack-2x"></i>
                                                        <i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
                                                    </span>
                                                </a>
                                                <a href="islemler/delete.php?haber_id=<?php echo $row["id"]; ?>" class="table-link danger">
                                                    <span class="fa-stack">
                                                        <i class="fa fa-square fa-stack-2x"></i>
