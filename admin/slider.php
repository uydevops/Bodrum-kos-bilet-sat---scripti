...
if ($oturum_ac["perm"] == "Admin") { ?>
    ...
    <form action="slider.php" class="dropzone">
                        ...
                        <div class="table-responsive">
                            <table class="table user-list">
                                <thead>
                                    ...
                                    <tr>
                                        <th><span>Slider Resimleri</span></th>
                                ...
                                <tbody>
                                    ...
                                    $user_cek = $db->prepare("SELECT *FROM slider");
                                    $user_cek->execute();
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="width: 20%;">
                                                ...
                                                <a href="slider_up.php?slider_up=<?php echo $row["id"]; ?>"" class=" table-link text-info">
                                                    <span class="fa-stack">
                                                        <i class="fa fa-square fa-stack-2x"></i>
                                                        <i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
                                                    </span>
                                                </a>
                                                <a href="islemler/delete.php?slider_id=<?php echo $row["id"]; ?>" class="table-link danger">
                                                    <span class="fa-stack">
                                                        <i class="fa fa-square fa-stack-2x"></i>
...
if (!empty($_FILES)) {
    ...
    $galeri = $db->prepare("INSERT INTO slider SET resim=?");
