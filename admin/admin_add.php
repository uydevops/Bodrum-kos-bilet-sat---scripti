...
<div class="container light-style flex-grow-1 container-p-y">
    ...
    <div class="alert alert-danger" role="alert">
        Moderatör Site Ayarlarına ve Admin Ekleme Yetkisine Sahip Değildir !
    </div>
                ...
                <form action="islemler/add.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="form-label">Yetki (Admin,Moderatör)</label>

                            <input type="text" name="perm" class="form-control mb-1">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="pass" class="form-control" id="show">
                        </div>
                    </div>
    ...
    <div class="text-center mt-1">
        <button type="submit" name="admin_ekle" class="btn btn-primary">Kaydet</button>&nbsp;
    </div>
    </form>
</div>
